...
export default function SignupForm() {
  const { switchToSignin, onAuthSuccess } = useContext(AccountContext);
  const { login } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.message === "User registered successfully") {
        ...
        // const loginRes = await axios.post("/api/auth/login", { email: form.email, password: form.password }, { withCredentials: true });
        // if (loginRes.data.token) login(loginRes.data.token);
